...
$(document).ready(function(){
    ...
    $(".card-header-right .reload-card").on("click",function(){
        ...
        setTimeout(function(){
            ...
            a.parents(".card").removeClass("card-load")},3000)
    });
...
/*$("#more-details").on("click",function(){$(".more-details").slideToggle(500)});*/
...
//     setTop:"10px",setHeight:"calc(100% - 80px)",
// });
// $("#styleSelector .style-cont").slimScroll({setTop:"10px",height:"calc(100vh - 515px)",});
// var b=$(window).height()-80;
// $(".main-friend-list").slimScroll({
//     height:b,allowPageScroll:false,wheelStep:5,color:"#1b8bf9"
// });
